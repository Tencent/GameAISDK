...
YOLODetWrapperV3::YOLODetWrapperV3()
{
...
bool YOLODetWrapperV3::Initialize(char* pszNetFile, char *pszWeightFile)
{
	if (NULL == pszNetFile)
	{
...
boost::python::list  YOLODetWrapperV3::Detect(int rows, int cols, PyObject* pImageData)
{
...
BOOST_PYTHON_MODULE(YOLODetWrapperV3)
{
	boost::python::class_<YOLODetWrapperV3>("YOLODetWrapperV3")
		.def("Initialize", &YOLODetWrapperV3::Initialize)
		.def("Detect", &YOLODetWrapperV3::Detect);
