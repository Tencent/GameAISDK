...
bool CYOLOV3Det::Initialize(void *pParam)
{
    if (NULL == pParam)
    {
        return false;
...
bool CYOLOV3Det::Initialize(char *szNetFile, char *szWeightFile)
{
...
int CYOLOV3Det::Detect(const cv::Mat &oSrcImage, tagDetBBox* &pstResult, int &nNum)
{
    if (oSrcImage.empty())
    {
...
float CYOLOV3Det::IOU(tagDetBBox &box1, tagDetBBox &box2)
{
