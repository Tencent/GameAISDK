...
#ifndef GAME_AI_SDK_IMGPROC_UI_GAMESTATE_GAMERUNSTATE_H_
#define GAME_AI_SDK_IMGPROC_UI_GAMESTATE_GAMERUNSTATE_H_
...
#endif  // GAME_AI_SDK_IMGPROC_UI_GAMESTATE_GAMERUNSTATE_H_
