...
#ifndef GAME_AI_SDK_IMGPROC_UI_GAMESTATE_HALLSTATE_H_
#define GAME_AI_SDK_IMGPROC_UI_GAMESTATE_HALLSTATE_H_
...
#endif  // GAME_AI_SDK_IMGPROC_UI_GAMESTATE_HALLSTATE_H_
