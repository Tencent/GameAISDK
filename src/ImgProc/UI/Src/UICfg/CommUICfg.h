...
#ifndef GAME_AI_SDK_IMGPROC_UI_UICFG_COMMUICFG_H_
#define GAME_AI_SDK_IMGPROC_UI_UICFG_COMMUICFG_H_
  ...
  private:
    ...
    */
    ...
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool ReadTemplateFromJson(const int nIndex, const int nTemplate,
    ...
    */
    ...
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool ReadDragCheckItem(const char *pszRootDir, const int nIndex,
        tagUIState *pstUIState, CJsonConfig *pConfig);
    ...
    */
    ...
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool ReadCommItem(const char *pszRootPath, const int nIndex,
        tagUIState *pstUIState, CJsonConfig *pConfig);
...
#endif  // GAME_AI_SDK_IMGPROC_UI_UICFG_COMMUICFG_H__
