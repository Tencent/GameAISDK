...
//    int RecvFromMC(tagSrcImgInfo *pSrcImageInfo);
     ...
     * @return 0表示成功，-1表示失败
     */
    int RecvFromSDKTool(tagSrcImgInfo *pSrcImageInfo, std::vector<CTaskMessage> *pVecTaskMsg, int nAddr);
...
//    bool m_bConnectAgent;                // true表示应该给Agent发送结果，false表示应该给SDKTool发送结果
