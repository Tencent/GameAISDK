...
#ifndef GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_SERIALIZEPROTOBUF_H_
#define GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_SERIALIZEPROTOBUF_H_
...
class CUnSerialTaskMsg {
  ...
  private:
    ...
    */
    ...
    /*!
      ...
      * @return 0表示成功，-1表示失败
    */
    int UnSerialTaskMsgAgentPixElmts(IRegParam *poPixRegParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
    ...
    /*!
      ...
      * @return 0表示成功，-1表示失败
    */
    int UnSerialTaskMsgAgentStuckElmts(IRegParam *poStuckRegParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
    /*!
      ...
      * @return 0表示成功，-1表示失败
    */
    int UnSerialTaskMsgAgentNumberElmts(IRegParam *poNumRegParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
    ...
    /*!
      ...
      * @return 0表示成功，-1表示失败
    */
    int UnSerialTaskMsgAgentDeformElmts(IRegParam *poDeformRegParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
    ...
    /*!
      ...
      * @return 0表示成功，-1表示失败
    */
    int UnSerialTaskMsgAgentFixBloodElmts(IRegParam *poFixBloodRegParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
  ...
  private:
    typedef int (CUnSerialTaskMsg::*mFun)(IRegParam *pBaseParam,
        const tagPBAgentTaskTsk &stPBAgentTaskTsk);
...
#endif  // GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_SERIALIZEPROTOBUF_H_
/*!@}*/
