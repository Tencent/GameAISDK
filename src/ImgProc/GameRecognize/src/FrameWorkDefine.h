...
#ifndef FRAMEWORK_DEFINE_H_
#define FRAMEWORK_DEFINE_H_
...
typedef std::map<int, tagTaskElements>  tagReferObjTaskElements; // refer任务ID 对应的游戏任务ID以及Element数组
typedef std::map<int, std::vector<int>> tagObjTaskReferID; // 目标游戏任务ID对应的referID数组
