...
#ifndef GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_INICONFCLASS_H_
#define GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_INICONFCLASS_H_
...
#endif  // GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_INICONFCLASS_H_
