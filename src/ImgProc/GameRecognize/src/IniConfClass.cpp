...
int CIniConf::getPrivateStr(const char *pszSectionName, const char *pszKeyName, const char *pszDefaultStr,
                            char *pszRetValue, const int nRetLen)
{
    int nRet = 0;
    // 获取键值
    nRet = m_oInitConfig.getPrivateStr(pszSectionName, pszKeyName, pszDefaultStr, pszRetValue, nRetLen);
...
int CIniConf::getPrivateInt(const char *pszSectionName, const char *pszKeyName, const int nDefaultInt)
{
    int nRet = 0;
...
bool CIniConf::getPrivateBool(const char *pszSectionName, const char *pszKeyName, const int nDefaultInt)
{
    bool bRet = false;
