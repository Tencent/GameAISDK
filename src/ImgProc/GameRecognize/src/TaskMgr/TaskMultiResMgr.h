...
#ifndef GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMULTIRESMGR_H_
#define GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMULTIRESMGR_H_
...
class CMutiResMgr {
  public:
    ...
    */
    bool UpdateGameTask(std::map<int, TaskContext> *pmpTaskCtx,
    ...
    */
    ...
    /*!
      ...
      * @return true or false
    */
    bool LoadReferConfFile(std::map<int, CTaskParam> *pmpTaskParam,
  ...
  private:
    ...
    */
    ...
    /*!
      ...
      * @return true or false
    */
    bool LocationReferTask(CLocationRegParam *pLocationParam,
    ...
    /*!
      ...
      * @return true or false
    */
    bool BloodReferTask(CBloodLengthRegParam *pBloodLenParam,
        int nTaskID, const Json::Value &oTask);
    ...
    */
    ...
    /*!
      ...
      * @return true or false
    */
    bool UpdateLocationParam(int nTaskID, std::map<int, TaskContext> *pmpTaskCtx,
    ...
    /*!
      ...
      * @return true or false
    */
    bool UpdateBloodRegParam(int nTaskID, std::map<int, TaskContext> *pmpTaskCtx,
        IRegResult *pRegResult);

    void UpdateTaskByReferTask(int nTaskID, int nObjTaskID,
    ...
    /*!
      ...
      * @return true or false
    */
    bool UpdateGameTaskParam(int nTaskID, CTaskParam *pTaskParam, cv::Rect *pRect,
...
#endif  // GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMULTIRESMGR_H_
