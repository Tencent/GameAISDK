...
#ifndef GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMANAGER_H_
#define GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMANAGER_H_
...
#endif  // GAME_AI_SDK_IMGPROC_GAMERECOGNIZE_TASKMGR_TASKMANAGER_H_
