...
#ifndef GAME_AI_SDK_IMGPROC_COMM_IMGREG_RECOGNIZER_CDEFORMBLOODREG_H_
#define GAME_AI_SDK_IMGPROC_COMM_IMGREG_RECOGNIZER_CDEFORMBLOODREG_H_
...
#endif  // GAME_AI_SDK_IMGPROC_COMM_IMGREG_RECOGNIZER_CDEFORMBLOODREG_H_
