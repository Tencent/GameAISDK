...
#ifndef GAME_AI_SDK_IMGPROC_COMM_UTILS_INICONFIG_H_
#define GAME_AI_SDK_IMGPROC_COMM_UTILS_INICONFIG_H_
  ...
  public:
    ...
    */
    ...
    int ProcessOperateThree(const char *pszDefaultStr, char *pszRetValue, const int nRetLen,
        char *pstrtmp, int  ntmp, char  *pszOneLine, const int nBufLen);
    int ProcessOperateFour(const char *pszSectionName, const char *pszKeyName,
...
#endif  // GAME_AI_SDK_IMGPROC_COMM_UTILS_INICONFIG_H_
