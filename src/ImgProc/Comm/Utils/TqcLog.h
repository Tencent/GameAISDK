    ...
    {                                                                                                       \
        ...
        {                                                                                                   \
            ...
            {                                                                                               \
                ...
                CLog::getInstance()->logWrite(CLog::LOG_PRIORITY_ERROR, szErrLogBuf, strlen(szErrLogBuf));  \
            }                                                                                               \
            ...
            {                                                                                               \
                ...
                CLog::getInstance()->logWrite(CLog::LOG_PRIORITY_WARN, szWarnLogBuf, strlen(szWarnLogBuf)); \
            }                                                                                               \
            ...
            {                                                                                               \
                ...
                CLog::getInstance()->logWrite(CLog::LOG_PRIORITY_RUN, szRunLogBuf, strlen(szRunLogBuf));    \
            }                                                                                               \
        ...
        {                                                                                                   \
            ...
            {                                                                                               \
                ...
                SNPRINTF(szDeLogBuf, sizeof(szDeLogBuf), "%s|%s|%s:%d|DEBUG|%s\n",                          \
                         ...
                         __FILE__, __FUNCTION__, __LINE__, szContent);                                      \
                printf("%s", szDeLogBuf);                                                                   \
                CLog::getInstance()->logWrite(CLog::LOG_PRIORITY_RUN, szDeLogBuf, strlen(szDeLogBuf));      \
            }                                                                                               \
        }                                                                                                   \
    }                                                                                                       \
    while (0)
